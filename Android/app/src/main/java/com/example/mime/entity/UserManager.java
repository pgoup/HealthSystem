...
public class UserManager {
    ...
    public UserInfo getUserInfo(Context context) {
      ...
      */
        userInfo.setAccount(preferences.getString("account", ""));
        return userInfo;
    }
    ...
    public void logOut(Context context) {
        SharedPreferences preferences = context.getSharedPreferences("userInfo", Context.MODE_PRIVATE);//获取上下文关于userInfo的SharePreferences对象
        SharedPreferences.Editor editor = preferences.edit();//获取preferences对象的Editor对象
        editor.clear();//清空editor对象内容
        editor.commit();//提交
    }
