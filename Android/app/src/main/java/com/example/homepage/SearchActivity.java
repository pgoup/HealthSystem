...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        int searchKind = Integer.valueOf(bundle.get("searchKind").toString());
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final String content = searchContent.getText().toString();//获取搜索框中的内容
                pageCount = 1;
                kind = content;
                //构建新的线程请求服务端，然后更新显示的内容
                new Runnable() {
                    @Override
                    public void run() {
        ...
        contentAdapter = new RecipeContentAdapter(this, new ArrayList<RecipeItemClient>(), searchKind);
