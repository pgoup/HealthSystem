...
public class ClassifyDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case MENU_TYPE:
                return new ClassifyDetailAdapter.MenuViewHolder(inflater.inflate(R.layout.classify_detail_menu, parent, false));
            case CONTENT_TYPE:
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ClassifyDetailAdapter.MenuViewHolder) {
            ClassifyDetailAdapter.MenuViewHolder menuViewHolder = (ClassifyDetailAdapter.MenuViewHolder) holder;
            for (int i = 0; i < 10; i++) {
                ...
                menuViewHolder.linearLayout.addView(button);
            }

        } else if (holder instanceof ClassifyDetailAdapter.ContentViewHolder) {
