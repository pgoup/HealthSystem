...
public interface FoodDao extends JpaRepository<Food, Long> {
     ...
     * 根据名称获取具体的食物信息
     */
    @Query(value = "select food_name,pic_path,health_worth,introduction,benefit,suitable_people,taboo_people,nutritional_ingredient from food where food_name = ?1 limit 1", nativeQuery = true)
